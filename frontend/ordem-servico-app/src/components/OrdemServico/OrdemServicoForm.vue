          ...
          <v-form ref="form" v-model="valid" @submit.prevent="submitForm">
            <v-container>
              <v-row>
                ...
                <v-col cols="12" md="6">
                  <v-select
                    v-model="ordemServico.tipo_servico"
                    :items="tiposServico"
                    item-title="nome"
                    item-value="id"
                    ...
                    multiple
                    chips
                    :rules="[v => v.length > 0 || 'Selecione pelo menos um tipo de serviço']"
                    required
                  ></v-select>
                </v-col>
              </v-row>
              ...
              <v-row>
                <v-col cols="12" md="6">
                  <v-text-field
                    v-model="ordemServico.data_servico"
                ...
                <v-col cols="12" md="6">
                  <v-text-field
                    v-model="ordemServico.tempo_garantia"
                    label="Tempo de Garantia"
                    :rules="[v => !!v || 'Tempo de garantia é obrigatório']"
                    required
                  ></v-text-field>
                </v-col>
              </v-row>
              ...
              <v-row>
                <v-col cols="12" md="6">
                  <v-text-field
                    v-model.number="ordemServico.valor_mao_obra"
                    label="Valor Mão de Obra"
                    type="number"
                    prefix="R$"
                    :rules="[v => v >= 0 || 'Valor deve ser maior ou igual a zero']"
                    required
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" md="6">
                  <v-text-field
                    v-model.number="ordemServico.valor_material"
              ...
              <v-row>
                <v-col cols="12">
                  <v-textarea
                    v-model="ordemServico.descricao"
                    label="Descrição"
              ...
              <v-row>
                <v-col cols="12">
                  <imagem-upload
                    v-model="ordemServico.imagens"
                    @update:modelValue="handleImagensChange"
                  />
                </v-col>
              </v-row>
            </v-container>
    ...
    methods: {
      ...
      prepareFormData() {
       ...
       /*  const statusMap = {
          ...
          'concluido': 'concluido',       // Manter sem alteração
          'cancelado': 'cancelado'        // Manter sem alteração
        };
