                  ...
                  <v-card outlined>
                    ...
                    <v-card-text>
                      ...
                      <v-btn
                        ...
                        :disabled="!ordemServico || novoStatus === (ordemServico?.status?.toLowerCase() || '')"
...
const statusOptions = [
{ text: 'Orçamento', value: 'orcamento' }, // lowercase
    { text: 'Aprovado', value: 'aprovado' },   // lowercase
    { text: 'Em Andamento', value: 'em_andamento' }, // lowercase
    { text: 'Concluído', value: 'concluido' }, // lowercase
    { text: 'Cancelado', value: 'cancelado' } // lowercase
]
...
const onStatusSelectionChange = (value) => {
    console.log("v-select mudou para:", value);
